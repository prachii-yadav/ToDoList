...
import { MongoTaskRepository } from './repositories/task.repository.mongo';
...
app.use(requestLoggerMiddleware);          // log every request + attach request ID
app.use(compression());                   // gzip responses
app.use(express.json({ limit: '10kb' })); // parse JSON — hard limit prevents large-body attacks
app.use(sanitizeMiddleware);              // strip prototype-pollution keys from body
